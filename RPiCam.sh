...
case "$1" in
  ...
  install)
    ...
    sudo cp -r etc/apache2/sites-available/default.1 /etc/apache2/sites-available/default
    ...
    sudo cp etc/sudoers.d/RPiCam /etc/sudoers.d/
    sudo chmod 440 /etc/sudoers.d/RPiCam
    ...
    sudo cp -r etc/raspimjpeg/raspimjpeg.1 /etc/raspimjpeg
    ...
    sudo cp -r etc/rc_local_run/rc.local.1 /etc/rc.local
    sudo chmod 755 /etc/rc.local

    sudo cp -r etc/motion/motion.conf.1 /etc/motion/motion.conf
