<?php
   ...
   function diskUsage() {
      ...
      if ($percentUsed > 98)
         ...
         $colour = 'LightGreen';
      echo '<a class="navbar-brand" href="index.php"><img style="width:50px;height:50px;margin-left: 10px;margin-right: 10px;" src="/img/home.png"></a> <div style="margin-left:5px;float:right;position:relative;width:calc(100vw - 100px);border:1px solid #ccc;">';
